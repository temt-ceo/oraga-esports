...
declare class __sveltets_Render<T extends PIXI.BitmapText> {
    props(): {
        ...
        text: string;
        style?: PIXI.IBitmapTextStyle | undefined;
    };
    events(): {
...
export type BitmapTextProps<T extends PIXI.BitmapText> = ReturnType<__sveltets_Render<T>['props']>;
export type BitmapTextEvents<T extends PIXI.BitmapText> = ReturnType<__sveltets_Render<T>['events']>;
export type BitmapTextSlots<T extends PIXI.BitmapText> = ReturnType<__sveltets_Render<T>['slots']>;
export default class BitmapText<T extends PIXI.BitmapText> extends SvelteComponentTyped<BitmapTextProps<T>, BitmapTextEvents<T>, BitmapTextSlots<T>> {
}
export {};
