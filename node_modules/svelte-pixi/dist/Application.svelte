<script context="module">export function getApp() {
 ...
 */
export let useContextAlpha = undefined;
/**
 * Resizes renderer view in CSS pixels to allow for resolutions other than 1.
 */
export let autoDensity = true;
/**
 * Sets antialias
 */
 ...
 * @type {number}
 */
export let resolution = PIXI.settings.RESOLUTION;
/**
 ...
 * @type {boolean}
 */
export let clearBeforeRender = undefined;
/**
 ...
 * @type {PIXI.EventMode}
 */
export let eventMode = undefined;
/**
 * The event features that are enabled by the EventSystem.
 *
 * @type {PIXI.EventSystemOptions['eventFeatures']}
 */
export let eventFeatures = undefined;
/**
 ...
 */
export let powerPreference = undefined;
/**
 * **WebGL Only.** Whether the compositor will assume the drawing buffer contains colors with premultiplied alpha.
 * @type {boolean | undefined}
 */
export let premultipliedAlpha = undefined;
/**
 * Element to automatically resize stage to.
 *
 * @type {Window | HTMLElement}
 */
export let resizeTo = undefined;
/**
 ...
 */
export let instance = new PIXI.Application(
...
setContext('pixi/app', { app: instance });
