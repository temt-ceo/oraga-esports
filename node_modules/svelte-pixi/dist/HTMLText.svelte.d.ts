...
declare class __sveltets_Render<T extends PIXI.HTMLText> {
    props(): {
        ...
        pivot?: PointLike | undefined;
        position?: PointLike | undefined;
        renderable?: boolean | undefined;
        rotation?: number | undefined;
        scale?: PointLike | undefined;
        skew?: PointLike | undefined;
        ...
        text: string;
        style?: PIXI.IHTMLTextStyle | undefined;
        anchor?: PointLike | undefined;
...
export type HtmlTextProps<T extends PIXI.HTMLText> = ReturnType<__sveltets_Render<T>['props']>;
export type HtmlTextEvents<T extends PIXI.HTMLText> = ReturnType<__sveltets_Render<T>['events']>;
export type HtmlTextSlots<T extends PIXI.HTMLText> = ReturnType<__sveltets_Render<T>['slots']>;
export default class HtmlText<T extends PIXI.HTMLText> extends SvelteComponentTyped<HtmlTextProps<T>, HtmlTextEvents<T>, HtmlTextSlots<T>> {
}
export {};
