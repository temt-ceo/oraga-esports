<script context="module">export function getContainer() {
 ...
 * @type {string}
 */
export let accessibleType = 'button';
/**
 ...
 */
export let cacheAsBitmapMultisample = PIXI.MSAA_QUALITY.NONE;
/**
 ...
 * @type {number}
 */
export let cacheAsBitmapResolution = undefined;
/**
 ...
 * @type {boolean}
 */
export let isMask = undefined;
/**
 * Used to fast check if a sprite is.. a sprite!
 *
 * @type {boolean}
 */
export let isSprite = undefined;
/**
...
const { applyProp, applyProps } = createApplyProps(instance);
...
if (!parent) {
    setContext('pixi/stage', { stage: instance });
}
setContext('pixi/container', { container: instance });
</script>
