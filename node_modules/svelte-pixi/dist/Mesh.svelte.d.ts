...
declare class __sveltets_Render<T extends PIXI.Mesh> {
    props(): {
        ...
        drawMode?: PIXI.DRAW_MODES | undefined;
    };
    events(): {
...
export type MeshProps<T extends PIXI.Mesh> = ReturnType<__sveltets_Render<T>['props']>;
export type MeshEvents<T extends PIXI.Mesh> = ReturnType<__sveltets_Render<T>['events']>;
export type MeshSlots<T extends PIXI.Mesh> = ReturnType<__sveltets_Render<T>['slots']>;
export default class Mesh<T extends PIXI.Mesh> extends SvelteComponentTyped<MeshProps<T>, MeshEvents<T>, MeshSlots<T>> {
}
export {};
