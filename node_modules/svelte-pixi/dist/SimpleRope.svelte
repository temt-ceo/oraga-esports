...
import { parsePoint } from './util/data-types';
 ...
 */
export let drawMode = undefined;
/**
 * The PIXI.SimpleRope instance. Can be set or bound to.
 *
 * @type {PIXI.SimpleRope}
 */
export let instance = new PIXI.SimpleRope(texture, parsePoints(points), textureScale);
...
const { applyProp } = createApplyProps(instance, {
    ...
    points: (value, instance) => {
        instance.geometry = new PIXI.RopeGeometry(texture.height, parsePoints(value), textureScale);
    },
});
